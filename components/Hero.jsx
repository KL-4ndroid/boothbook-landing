...
export default function Hero() {
  return (
    <section id="top" className="feria-noise relative py-16 md:py-24">
      <div className="container-page relative z-10 grid items-center gap-12 lg:grid-cols-[0.88fr_1.12fr]">
        <div>
          ...
          <p className="feria-copy mt-6 max-w-xl text-lg font-medium">
            Féria｜出攤筆記，是為手作品牌與市集攤主設計的經營筆記工具。記錄市集、商品、成本與成果，讓你不只是努力出攤，也能慢慢看懂自己的品牌。
          </p>
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            ...
            <a href="#waitlist" className="inline-flex items-center justify-center rounded-2xl border border-feria-line bg-feria-cream px-7 py-4 font-semibold text-feria-olive shadow-card transition hover:-translate-y-0.5 hover:border-feria-taupe">
              追蹤 Threads
            </a>
          </div>
